<script>
  ...
  let cards = [
    ...
    {
      cardTitle: "Explore",
      cardDescription: "Discover user made climbs!",
      cardLink: "/explore"
    },
    {
      cardTitle: "Create",
      cardDescription: "Publish your own route!",
      cardLink: "/create"
    },
  ]
</script>
...
<header class="hero">
<h1>-Welcome to CRIMP-</h1>
<h3>Setting has never been easier</h3>
</header>
...
.hero {
  ...
  background-image: src("../images/71.jpg");
